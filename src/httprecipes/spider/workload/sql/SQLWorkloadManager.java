package httprecipes.spider.workload.sql;
...
import httprecipes.spider.*;
import httprecipes.spider.workload.*;
...
public class SQLWorkloadManager implements WorkloadManager
{
  ...
  private static Logger logger = Logger
      .getLogger("httprecipes.spider.workload.sql.SQLWorkloadManager");
