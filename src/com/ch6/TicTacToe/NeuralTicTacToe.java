package com.ch6.TicTacToe;

import java.io.IOException;
import java.io.Serializable;
import java.util.Date;
import java.util.concurrent.Executors;
import com.ch6.TicTacToe.game.Game;
import com.ch6.TicTacToe.game.ScorePlayer;
import com.ch6.TicTacToe.players.Player;
import com.ch6.TicTacToe.players.PlayerBoring;
import com.ch6.TicTacToe.players.PlayerHuman;
import com.ch6.TicTacToe.players.PlayerLogic;
import com.ch6.TicTacToe.players.PlayerRandom;
import com.ch6.TicTacToe.players.minmax.PlayerMinMax;
import com.ch6.TicTacToe.players.neural.PlayerNeural;
import com.ch6.TicTacToe.players.neural.TicTacToeGenetic;
...
//    public final static int TRAIN_MINUTES = 300;
    ...
    public static void main(final String[] args) {
        try {
            ...
            String[] parametros = {"Train", "NeuralBlank", "Random"};
            ...
            final Player player1 = getPlayer(parametros[1]);
            final Player player2 = getPlayer(parametros[2]);
            ...
            if (parametros[0].equalsIgnoreCase("game")) {
                ttt.singleGame();
            } else if (parametros[0].equalsIgnoreCase("match")) {
                ttt.playMatch();
            } else if (parametros[0].equalsIgnoreCase("train")) {
                ttt.geneticNeural();
            } else {
    ...
    public void geneticNeural() throws IOException {
        ...
        SerializeObject.save("tictactoe.net",(Serializable) train.getNetwork());
    }
