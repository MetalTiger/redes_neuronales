...
public class AnnealTravelingSalesman extends JFrame implements Runnable,
    ...
    public void componentShown(final ComponentEvent e) {
        ...
        this.anneal = new TSPSimulatedAnnealing(this.cities, START_TEMPERATURE, STOP_TEMPERATURE, CYCLES);
    ...
    public void run() {
        ...
        while (countSame < 10) {
            ...
            System.out.println("Epoc:" + this.epoc + ", Cost = " + thisCost);
        ...
        System.out.println("Solution found after " + this.epoc + " epocs.");
