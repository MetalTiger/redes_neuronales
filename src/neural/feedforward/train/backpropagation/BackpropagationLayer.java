package neural.feedforward.train.backpropagation;
...
public class BackpropagationLayer {
    ...
    /**
     * Contains the error of each input.
     * */
    private final double[] error;

    /**
     * Contains the delta node of each input.
     * */
    private final double[] errorDelta;

    /**
     * Accumulate the error deltas (gradients) for each weight matrix and bias value.
     */
    ...
    /**
     * Hold the previous matrix deltas of weights so that "momentum" can be implemented.
