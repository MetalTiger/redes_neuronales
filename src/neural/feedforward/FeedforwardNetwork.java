...
public class FeedforwardNetwork implements Serializable {
     ...
     */
    public double calculateError(final double[][] input, final double[][] ideal) throws NeuralNetworkError {
    ...
    public double[] computeOutputs(final double[] input) {
        ...
        if (input.length != this.inputLayer.getNeuronCount()) {
            ...
            "Size mismatch: Can't compute outputs for input size=" + input.length
